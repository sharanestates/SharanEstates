    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-light)', paddingTop: '8rem', paddingBottom: '6rem' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 1.5rem' }}>
        ...
        <div style={{ marginBottom: '3rem', textAlign: 'center' }}>
          <div style={{ width: '40px', height: '1px', background: 'rgba(0,0,0,0.12)', margin: '0 auto 1rem' }} />
          <p style={{ color: 'var(--text-muted)', fontSize: '0.75rem', letterSpacing: '4px', textTransform: 'uppercase', fontWeight: 600, marginBottom: '0.75rem' }}>
            Legal Documents
          </p>
          ...
          <div style={{ width: '50px', height: '1px', background: 'rgba(0,0,0,0.12)', margin: '1.5rem auto 0' }} />
        </div>
