...
export default function AboutPage() {
  useSEO(
    'About Us',
    'Learn about Sharan Estates, our history, our values, and our commitment to providing premium luxury real estate services in Dubai.'
  );
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-light)', paddingBottom: '4rem' }}>
      ...
      <RevealSection>
        <section style={{ paddingTop: 'clamp(5rem, 12vw, 8rem)', paddingBottom: '1rem', textAlign: 'center' }}>
          ...
          <div style={{ width: '40px', height: '1px', background: 'rgba(0,0,0,0.15)', margin: '0 auto 1.5rem' }} />
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', letterSpacing: '2px', textTransform: 'uppercase', fontWeight: 600, marginBottom: '1rem' }}>
              Our Story
            </p>
            <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', color: 'var(--text-dark)', fontFamily: 'var(--font-serif)', lineHeight: 1.1, marginBottom: '2rem' }}>
              The Standard of <br/><span style={{ color: 'var(--primary-dark)' }}>Excellence</span>
            </h1>
      ...
      {/* Key Metrics Section */}
      <RevealSection>
        <section className="scene-3d" style={{ position: 'relative', overflow: 'hidden', padding: '2rem 0' }}>
          <div style={{ position: 'absolute', top: '-10%', left: '-5%', width: '30%', height: '50%', background: 'radial-gradient(circle, rgba(0, 0, 0, 0.15) 0%, transparent 70%)', zIndex: 0, filter: 'blur(40px)' }}></div>
          ...
          <div className="container p-mobile" style={{ background: 'var(--text-dark)', display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '3rem', padding: '4rem 3rem', zIndex: 1, maxWidth: '1200px', margin: '0 auto', borderRadius: '4px', boxShadow: '0 15px 40px rgba(0,0,0,0.1)' }}>
            ...
            <div style={{ flex: '1 1 300px', position: 'relative', height: 'clamp(350px, 60vw, 500px)', width: '100%' }}>
              <div style={{ position: 'absolute', top: 0, right: 0, width: '70%', height: '75%', zIndex: 2 }}>
                <img src="/luxury_flats.webp" alt="Luxury Flats Interior" loading="lazy" style={{ border: '3px solid white', width: '100%', height: '100%', objectFit: 'cover', borderRadius: '4px' }} />
              </div>
              <div style={{ position: 'absolute', bottom: 0, left: 0, width: '65%', height: '70%', zIndex: 3, transform: 'translateZ(30px)' }}>
                <img src="/modern_infrastructure.webp" alt="Modern Infrastructure" loading="lazy" style={{ border: '3px solid white', width: '100%', height: '100%', objectFit: 'cover', borderRadius: '4px' }} />
              </div>
            </div>
          ...
          <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(350px, 100%), 1fr))', gap: '3rem' }}>
              ...
              <div>
                <div className="classic-property-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column', height: '100%' }}>
                  <div style={{ height: '350px', position: 'relative' }}>
                    <img src="/founder.webp" alt="Founder" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                  </div>
              ...
              <div>
                <div className="classic-property-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column', height: '100%' }}>
                  <div style={{ height: '350px', position: 'relative' }}>
                    <img src="/founder.webp" alt="Executive" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover', filter: 'hue-rotate(15deg) contrast(1.1)' }} />
                  </div>
                  <div style={{ padding: '2rem', textAlign: 'center', flex: 1 }}>
